...
DOMAIN_DEPENDENCIES = {
    "adapters": {"facade", "core", "infrastructure", "lfs", "sdk", "services", "transfers"},
    "compatibility": {"core", "interfaces", "usecases"},
    "core": set(),
    "facade": {
        "cli",
        "sdk",
