...
CURRENT_INTERNAL_EDGES = {
    ...
    ("adapters.sdk_uploads", "sdk.errors"),
    ...
    ("api.__init__", "adapters.lfs.__init__"),
    ("api.__init__", "adapters.lfs.pointer"),
    ("api.__init__", "adapters.lfs.service"),
    ("api.__init__", "runtime"),
    ("api.__init__", "services.authentication"),
    ("api.__init__", "services.__init__"),
    ("api.__init__", "services.repositories"),
    ("api.__init__", "adapters.upload.__init__"),
    ("api.__init__", "adapters.upload.service"),
    ("api.__init__", "utils"),
    ...
    ("infrastructure.release", "lifecycle.environment"),
    ...
    ("sdk.errors", "adapters.lfs.pointer"),
