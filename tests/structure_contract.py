...
CURRENT_INTERNAL_EDGES = {
    ("adapters.__init__", "adapters.atomgit_v5"),
    ("adapters.__init__", "adapters.download.__init__"),
    ("adapters.__init__", "adapters.huggingface"),
    ...
    ("adapters.huggingface", "api.__init__"),
    ("adapters.huggingface", "adapters.download.__init__"),
    ("adapters.huggingface", "lfs_pointer"),
    ("adapters.huggingface", "upload.service"),
    ("adapters.huggingface", "sdk.__init__"),
    ...
    ("api.__init__", "config"),
    ("api.__init__", "adapters.download.__init__"),
    ...
    ("services.authentication", "adapters.atomgit_v5"),
    ("services.repositories", "adapters.atomgit_v5"),
    ...
    ("download.integrity", "adapters.download.integrity"),
    ("download.manifest", "adapters.download.manifest"),
    ("download.prune", "adapters.download.prune"),
    ("download.resume", "adapters.download.resume"),
    ("download.service", "adapters.download.service"),
    ("download.service", "infrastructure.config"),
    ("download.service", "infrastructure.validation"),
    ("download.transport", "adapters.download.transport"),
    ("upload.errors", "infrastructure.validation"),
    ("upload.errors", "upload.projection"),
    ("upload.projection", "adapters.download.transport"),
    ("upload.resumable", "adapters.download.integrity"),
    ("upload.resumable", "adapters.download.transport"),
    ...
    ("interfaces.cli.__init__", "adapters.__init__"),
    ("interfaces.cli.__init__", "adapters.download.service"),
    ("interfaces.cli.__init__", "infrastructure.validation"),
    ("interfaces.cli.__init__", "interfaces.sdk.__init__"),
    ("cli.__init__", "interfaces.cli.__init__"),
...
LEGACY_FACADE_DEBT = {
    "api.__init__": {"max_lines": 779, "max_functions": 0, "max_classes": 1},
    "atomgit_hub": {"max_lines": 158, "max_functions": 2, "max_classes": 0},
    "cli.__init__": {"max_lines": 544, "max_functions": 26, "max_classes": 1},
