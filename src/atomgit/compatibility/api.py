...
_UPLOAD_OWNER_EXPORTS = {
    ...
    "ResumableCommitConflictError": _upload_errors,
    "ResumableRecoveryStateError": _upload_errors,
    ...
    "_PENDING_COMMIT_VERSION": _upload_resumable,
    "_PENDING_COMMIT_MAX_BYTES": _upload_resumable,
    "_PENDING_COMMIT_MAX_OPERATIONS": _upload_resumable,
    "_PENDING_COMMIT_DIRECTORY": _upload_resumable,
    "_PENDING_COMMIT_FILENAME": _upload_resumable,
    "_PENDING_COMMIT_LOCK_FILENAME": _upload_resumable,
    "_pending_commit_paths": _upload_resumable,
    "_validated_pending_commit_operation": _upload_resumable,
    "_validated_pending_commit": _upload_resumable,
    "_read_pending_commit": _upload_resumable,
    "_write_pending_commit": _upload_resumable,
    "_delete_pending_commit": _upload_resumable,
    "_resumable_projection_lock": _upload_resumable,
    "_commit_error_status": _upload_resumable,
    "_resolve_resumable_revision": _upload_resumable,
    "_operation_pending_record": _upload_resumable,
    "_pending_commit_value": _upload_resumable,
    "_local_pending_record_matches": _upload_resumable,
    "_mark_pending_records_committed": _upload_resumable,
    "_remote_pending_record_matches": _upload_resumable,
    "_recover_pending_commit": _upload_resumable,
...
_UPLOAD_OWNER_CONSUMERS = {
    ...
    "ResumableCommitConflictError": (_upload_errors, _upload_resumable),
    "ResumableRecoveryStateError": (_upload_errors, _upload_resumable),
    ...
    "_resumable_projection_lock": (_upload_resumable, _upload_service),
...
_UPLOAD_PATCH_TARGETS = {
    ...
    "_atomgit_v5_commit_sha": (_upload_resumable,),
