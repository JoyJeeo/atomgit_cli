"""CLI API LFS policy, transfer recovery, and attributes ownership.

This module owns the implementation while atomgit.api preserves the historical
compatibility surface and injects its former module-level dependencies.
"""
